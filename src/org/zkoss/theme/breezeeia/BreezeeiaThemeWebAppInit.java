...
*/
package org.zkoss.theme.breezeeia;
 ...
 * 
 */
public class BreezeeiaThemeWebAppInit implements WebAppInit {

	private final static String THEME_NAME = "breezeeia";
	private final static String THEME_DISPLAY = "breeze-eia";
